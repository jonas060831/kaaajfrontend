  ...
  return (
    <div className={styles.container}>
          ...
          <div className={styles.steps_and_map_container}>
            ...
            <div style={{ width: '55%' }}>
              <img src="src/assets/images/map/map_darkmode.jpeg" alt="" style={{ height: '100%', width: '100%', objectFit: 'fill', borderTopLeftRadius: '18vw', borderBottomRightRadius: '10vw', filter: 'drop-shadow(1px 1px 6px orange) brightness(60%)' }}/>
            </div>
